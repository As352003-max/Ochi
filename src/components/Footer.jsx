...
const Footer = () => {
  return (
    <div  className="w-full gap-10 h-screen bg-zinc-900 font-['Founders_Grotesk_X-Condensed'] p-20  flex flex-row ">
        

        <div  className="w-1/2 h-full flex flex-col  justify-between ">
        <div className="heading">
        <h1  className="text-[5.4vw] font-semibold uppercase leading-none -mb-10">Eye-</h1>
        <h1 className="text-[5.4vw]  font-semibold uppercase leading-[1.6] -mb-10">Opening</h1>
        </div>
        ...
        <div className="w-1/2 ">
        <h1 className="text-[5.4vw] font-semibold uppercase leading">Presentations</h1>
        <div className="flex flex-row gap-10 justify-evenly">
        
        <div className="dets flex flex-col uppercase underline mt-10">
        <h3 className="text-3xl ">S:</h3>
        <a href="#" >Facebook</a>
        <a href="#">Instagram</a>
        <a href="#">Twitter</a>
        <a href="#">LinkedIn</a>
